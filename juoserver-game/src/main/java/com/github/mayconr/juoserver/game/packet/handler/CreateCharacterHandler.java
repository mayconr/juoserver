...
public
class CreateCharacterHandler extends SimpleChannelInboundHandler<CreateCharacter> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, CreateCharacter msg) throws Exception {
        ...
        database.createPlayer(details); // TODO initialize session if gameplay be started automatically
