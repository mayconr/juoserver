...
public class GeneralInformationHandler extends PlayerSessionChannelInboundHandler<GeneralInformation> {
    @Override
    protected void channelRead0(PlayerSession session, ChannelHandlerContext ctx, GeneralInformation msg) {
