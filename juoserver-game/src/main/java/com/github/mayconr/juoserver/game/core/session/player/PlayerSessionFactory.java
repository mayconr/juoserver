...
public class PlayerSessionFactory {
    ...
    public PlayerSession createPlayerSession(UOMobile mobile, ChannelHandlerContext ctx) {
        ...
        return new DefaultPlayerSession(mobile, initializationServie, speechService, movementService, itemIteractionService, clickService, megaClilocService, targetService);
    }
